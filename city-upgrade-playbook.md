...
## תיקוני slug ידועים (slugים שמחזירים soft-404, להשתמש בגרסה הנכונה)
- בני ברק: `מצבר-עד-הבית-בני-ברק` (בלי "ב")
- גבעת שמואל: `מצבר-עד-הבית-גבעת-שמואל` (בלי "ב")
- קריית אונו: `מצבר-עד-הבית-קרית-אונו` (בלי "ב", "קרית" ביו"ד אחת)
- פתח תקווה: `מצבר-עד-הבית-פתח-תקווה` (בלי "ב")
- ראש העין: `מצבר-עד-הבית-ראש-העין` (בלי "ב")
- כפר יונה: `מצבר-עד-הבית-בכפר-יונה-השירות-המהיר-המ` (slug קנוני ארוך; הקצר עושה 301)
כלל: רוב הערים עם "ב" בתחילת ה-slug, אך חלק בלי. תמיד לאמת 200 לפני שמירה.
...
✅ **10/10 הערים המובילות הושלמו ואומתו:** תל אביב, ראשון לציון, פתח תקווה, חולון, בת ים, רמת גן, נתניה, רחובות, אשדוד, מודיעין.
הבא בתור (אם מרחיבים): שאר ~28 הערים ב-service-areas, באותו פלייבוק בדיוק.
