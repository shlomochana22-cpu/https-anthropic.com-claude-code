    ...
    <>
      ...
      <main className="pt-20 pb-32 px-margin-mobile max-w-2xl mx-auto">
        <section className="mb-lg">
          <h1 className="text-headline-lg-mobile mb-1 text-primary">היי אלי, תמשיך ככה!</h1>
        ...
        <section className="mb-lg">
          <div className="glass-card p-md rounded-xl border-primary-fixed-dim/20 relative overflow-hidden">
            <div className="flex justify-between items-start">
              ...
              <Link href="/wallet" className="bg-primary-fixed-dim text-on-primary-fixed px-md py-sm rounded-full text-label-md active:scale-95 transition-transform shadow-neon-primary">
                משיכה
              </Link>
            </div>
          </div>
